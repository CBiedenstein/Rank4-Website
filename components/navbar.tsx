      ...
      <nav className="mx-auto flex max-w-[1400px] items-center justify-between px-6 py-4 pt-[max(1rem,env(safe-area-inset-top))] md:px-12 lg:px-20">
        ...
        <ul className="hidden items-center gap-8 md:flex">
          ...
          <li>
            <Link
              href="/contact"
              className="inline-flex items-center rounded-sm px-5 py-2 font-mono text-[11px] font-semibold uppercase tracking-[0.1em] transition-all hover:brightness-110"
        ...
        >
          <ul className="flex flex-col gap-4 pt-4">
            ...
            <li>
              <Link
                href="/contact"
                className="inline-flex items-center rounded-sm px-5 py-2 font-mono text-[11px] font-semibold uppercase tracking-[0.1em]"
                style={{ backgroundColor: "#7B0D1E", color: "#F1DAC4" }}
                onClick={() => setMobileOpen(false)}
              >
                Request Consultation
